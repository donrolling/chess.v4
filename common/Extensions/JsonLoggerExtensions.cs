...
public static class JsonLoggerExtensions
{
	...
	public static void LogJsonError(this ILogger logger, EventId eventId, Exception exception, string message,
		object arg)
	{
	...
	public static void LogJsonInformation(this ILogger logger, EventId eventId, string message,
		params object[] args)
	{
		var sb = new StringBuilder();
		sb.Append(message);
	...
	public static void LogJsonInformation(this ILogger logger, Exception exception, string message,
		List<object> args)
	{
	...
	public static void LogJsonInformation(this ILogger logger, EventId eventId, Exception exception, string message,
		object arg)
	{
	...
	private static void serializeArgs_AddToStringBuilder(object[] args, StringBuilder sb)
	{
		...
		foreach (var arg in args)
		{
			...
			var name = type.Name;
			var json = JsonSerializer.Serialize(arg, jsonSerializerSettings);
			sb.AppendLine($"\t{name}:\r\n\t{json}");
		}
	}
}