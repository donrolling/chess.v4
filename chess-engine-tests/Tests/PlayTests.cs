...
using chess_engine_tests.Models;
using Common.IO;
...
namespace chess_engine_tests.Tests
{
    ...
    public class PlayTests : TestBase
    {
        ...
        private PlayGameInfo playGamePrep(Game game)
        {
            ...
            FileIOEngine.WriteAllText("Data\\playGame.pgn", playGameInfo.GameString);
        ...
        private List<Game> import()
        {
            ...
            var data = FileIOEngine.ReadAllText("Data\\December1.pgn");
